...
const Nav = () => {
    return (
      <nav className="flex gap-5 items-center justify-between mt-5 container mx-auto sticky top-0">
        <div>
          <img src={logo} alt="logo-with-text" />
        </div>
        <div className="flex gap-5 text-[#475569] text-[14px] font-medium list-none">
